...
public class QueryUtils {
    ...
    //Query the guardian data set and return an{@link List} object to represent a single news
     ...
     */
    public static List<News> extractNews(String JSON_RESPONSE) {
        ...
        try {
            ...
            for(int i=0;i<newsArray.length();i++)
            {
                ...
                News mNews = new News(title,description,url,bmp);
                news.add(mNews);
            }
